...
int gameSpeed = 2000; // Intervalo inicial entre transições (em milissegundos)
...
void increaseGameSpeed() {
  if (gameSpeed > 500) { // Limita a velocidade mínima
...
void resetGame() {
  currentLED = 0;
  setRGBColor(200, 0, 200); // Lilás
  gameSpeed = 2000; // Reset da velocidade do jogo
  gameActive = true;
  updateLEDs();
  updateDirectLEDs();
}
